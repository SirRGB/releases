...
export ROM_DIR="${WORKSPACE}/../Los13"
export ROM_VERSION="20"
export local_manifest_url="https://raw.githubusercontent.com/SirRGB/local_manifests/main/a57y17lte/A13Lineage.xml"
export manifest_url="https://github.com/droid-legacy/android"
export rom_vendor_name="lineage"
export branch="lineage-20.0"
export bacon="bacon"
export buildtype="userdebug"
export clean="installclean"
export generate_incremental="false"
export upload_recovery="yes"
