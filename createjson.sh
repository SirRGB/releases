...
oem="Sony" #ex: OnePlus
device="aurora" #ex: guacamole
devicename="Xperia XZ2 Premium" #ex: OnePlus 7 Pro
...
forum="https://t.me/SonyXperiaChat" #https link (mandatory)
...
telegram="https://t.me/SonyXperiaChat" #https link (leave empty if unused)
