...
device="griffin" #ex: guacamole
devicename="Moto Z" #ex: OnePlus 7 Pro
zip="crDroidAndroid-11.0-${date}-griffin-v${CR_VERSION}.zip" #ex: crDroidAndroid-<android version>-<date>-<device codename>-v<crdroid version>.zip
buildtype="Monthly" #choose from Testing/Alpha/Beta/Weekly/Monthly
forum="https://forum.xda-developers.com/t/rom-11-crdroid-7-13-vanilla-gapps-for-griffin-unofficial-21dec.4296739/" #https link (mandatory)
...
telegram="https://t.me/+-3Km4jH4g1VjZDVi" #https link (leave empty if unused)
  ...
  "response": [
    {
        ...
        "device": "'$devicename'",
        "filename": "'$zip_only'",
        "download": "https://sourceforge.net/projects/sirrgb-roms/files/Griffin/crDroid/'$zip_only'/download",
        "timestamp": '$timestamp',
        "md5": "'$md5'",
        "size": '$size',
        "version": "'$version'",
